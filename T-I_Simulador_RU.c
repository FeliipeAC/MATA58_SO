...
int _refeicoes = 100;	/* Quantidade de refeições que serão servidas neste expediente	*/
/* Horário total de funcionamento do RU (Duração do Expediente)	*/
int _horarioFuncionamento = 150;		/* Com _horarioFuncionamento igual a 100, expediente dura aproximadamente 1m40s	*/
